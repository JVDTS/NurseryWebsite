  ...
  return (
    ...
    >
      ...
      >
        ...
        <motion.div variants={fadeUp} className="mb-10">
          <h2 className="text-2xl font-heading font-bold text-primary mb-6">Our Menu Cycles</h2>
          <p className="text-muted-foreground mb-6">
            ...
            >
              ...
              <div className="p-6">
                ...
                <a 
                  ...
                  className="inline-flex items-center gap-2 bg-primary/10 hover:bg-primary/20 text-primary px-4 py-2 rounded-md transition-colors"
                >
        ...
        <motion.div variants={fadeUp} className="bg-primary/5 rounded-lg p-6 border border-primary/10">
          <h3 className="text-xl font-heading font-bold mb-3 text-primary">Dietary Requirements and Allergies</h3>
          <p className="text-muted-foreground mb-4">
          ...
          <div className="grid gap-4 md:grid-cols-3">
            ...
            <div className="bg-white p-4 rounded-md shadow-sm border border-primary/10">
              <h4 className="font-semibold text-primary mb-2">Religious Requirements</h4>
            ...
            <div className="bg-white p-4 rounded-md shadow-sm border border-primary/10">
              <h4 className="font-semibold text-primary mb-2">Special Diets</h4>
